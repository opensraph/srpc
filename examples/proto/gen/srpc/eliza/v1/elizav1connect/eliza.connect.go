...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/opensraph/srpc/examples/proto/gen/srpc/eliza/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ElizaServiceName = "srpc.eliza.v1.ElizaService"
)
...
const (
	...
	ElizaServiceSayProcedure = "/srpc.eliza.v1.ElizaService/Say"
	// ElizaServiceConverseProcedure is the fully-qualified name of the ElizaService's Converse RPC.
	ElizaServiceConverseProcedure = "/srpc.eliza.v1.ElizaService/Converse"
	// ElizaServiceIntroduceProcedure is the fully-qualified name of the ElizaService's Introduce RPC.
	ElizaServiceIntroduceProcedure = "/srpc.eliza.v1.ElizaService/Introduce"
)

// ElizaServiceClient is a client for the srpc.eliza.v1.ElizaService service.
...
// NewElizaServiceClient constructs a client for the srpc.eliza.v1.ElizaService service. By default,
...
func NewElizaServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ElizaServiceClient {
	...
	elizaServiceMethods := v1.File_srpc_eliza_v1_eliza_proto.Services().ByName("ElizaService").Methods()
...
// Say calls srpc.eliza.v1.ElizaService.Say.
...
// Converse calls srpc.eliza.v1.ElizaService.Converse.
...
// Introduce calls srpc.eliza.v1.ElizaService.Introduce.
...
// ElizaServiceHandler is an implementation of the srpc.eliza.v1.ElizaService service.
...
func NewElizaServiceHandler(svc ElizaServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/srpc.eliza.v1.ElizaService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedElizaServiceHandler) Say(context.Context, *connect.Request[v1.SayRequest]) (*connect.Response[v1.SayResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("srpc.eliza.v1.ElizaService.Say is not implemented"))
}
...
func (UnimplementedElizaServiceHandler) Converse(context.Context, *connect.BidiStream[v1.ConverseRequest, v1.ConverseResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("srpc.eliza.v1.ElizaService.Converse is not implemented"))
}
...
func (UnimplementedElizaServiceHandler) Introduce(context.Context, *connect.Request[v1.IntroduceRequest], *connect.ServerStream[v1.IntroduceResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("srpc.eliza.v1.ElizaService.Introduce is not implemented"))
}
