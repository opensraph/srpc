...
import (
	...
	"github.com/opensraph/srpc/mem/internal"
)
...
func TestBuffer_NewBufferAndFree(t *testing.T) {
	data := "abcd"
	freed := false
...
func TestBuffer_NewBufferRefAndFree(t *testing.T) {
	data := "abcd"
	freed := false
	freeF := poolFunc(func(got *[]byte) {
		if !bytes.Equal(*got, []byte(data)) {
...
func TestBuffer_NewBufferHandlesShortBuffers(t *testing.T) {
	const threshold = 100
...
func TestBuffer_FreeAfterFree(t *testing.T) {
...
func TestBuffer_CopyAndFree(t *testing.T) {
	data := []byte("abcd")
...
// buffer pool.
func TestBuffer_CopyRefAndFree(t *testing.T) {
	data := []byte("abcd")
	testPool := &singleBufferPool{
		t:    t,
		data: &data,
...
func TestBuffer_ReadOnlyDataAfterFree(t *testing.T) {
...
func TestBuffer_RefAfterFree(t *testing.T) {
...
func TestBuffer_SplitAfterFree(t *testing.T) {
