...
const (
	Size256B = 1 << 8   // 256B
	Size4K   = 4 << 10  // 4KB (go page size)
	Size8K   = 8 << 10  // 8KB (max HTTP/2 header size used by gRPC)
	Size16K  = 16 << 10 // 16KB (max HTTP/2 frame size used by gRPC)
	Size32K  = 32 << 10 // 32KB (default buffer size for io.Copy)
	Size1M   = 1 << 20  // 1MB
)
